...
#SBATCH --output=slurm-quality-cnn-lstm-%j.out
...
apptainer exec --nv --bind /scratch/project_2018481:/scratch/project_2018481 \
    $SIF \
    python3 -m src.evaluate_quality --model cnn_lstm \
        ...
        --split test --out_dir results/quality_robustness
