...
#SBATCH --output=slurm-swin3d-aug-%j.out
...
apptainer exec --nv --bind /scratch/project_2018481:/scratch/project_2018481 \
    ...
    python3 -m src.train \
        ...
        --epochs 15 --lr 1e-3 --backbone_lr 1e-5 --weight_decay 1e-4 --dropout 0.3 \
        --freeze_epochs 2 --warmup_frac 0.1 --grad_clip 1.0 \
        --temporal_sampling clip --clip_period 2 \
        --augment
