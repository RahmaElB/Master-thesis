...
#SBATCH --output=slurm-eval-cnn-lstm-%j.out
...
apptainer exec --nv --bind /scratch/project_2018481:/scratch/project_2018481 \
    $SIF \
    python3 -m src.evaluate --model cnn_lstm \
        --checkpoint checkpoints/cnn_lstm_64f_112px_clipp1_pretrained_best.pt \
        --num_frames 64 --img_size 112 --temporal_sampling clip --clip_period 1 \
        --batch_size 4 --epochs 15 --lr 1e-4 --weight_decay 1e-4 --dropout 0.3 \
